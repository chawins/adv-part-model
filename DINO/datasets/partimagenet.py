...
def get_loader_sampler(args, transform, split: str):
    ...
    data_path = '/home/nabeel126/data/PartImageNet'
    seg_path = '/home/nabeel126/data/PartImageNet/BoxSegmentations/All/'
    ann_file_path = os.path.join(
        os.path.expanduser(data_path), "PartBoxSegmentations", f"{split}.json"
    )
