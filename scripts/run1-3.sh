...
#         --output-dir results/ct_kp_3 --experiment part-wbbox-norm_img-centroid-semi && break
#     sleep 30
# done
...
python -u main.py \
    ...
    --epsilon $EPS --atk-norm Linf --eval-attack aa --output-dir results/ct_kp_3 \
    --resume results/ct_kp_3/checkpoint_best.pt \
