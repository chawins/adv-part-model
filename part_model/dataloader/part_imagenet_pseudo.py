...
class PartImageNetSegDataset(data.Dataset):
    ...
    def _get_data(self):
        ...
        for l, label in enumerate(self.classes):
            img_path = os.path.join(self.root, "JPEGImagesImageNet")
            ...
            images.extend([f"{img_path}/{f}.jpg" for f in filenames])
...
def get_loader_sampler(args, transform, split):
    ...
    setattr(args, "num_classes", 11)  # TODO: fix
    ...
    setattr(args, "seg_labels", 41)  # TODO: fix
